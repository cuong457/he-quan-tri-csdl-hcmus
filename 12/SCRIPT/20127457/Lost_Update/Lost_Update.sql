...
begin transaction
	begin try
		...
		select @SoLuongBanDau = SOLUONG from MONAN where MAMONAN=@MONAN and THUCDON=@THUCDON
		
		-- Test
		WAITFOR DELAY '0:0:05'

		update MONAN set SOLUONG=(@SoLuongBanDau - @SOLUONG) where MAMONAN=@MONAN and THUCDON=@THUCDON
